AI Chatbot:
• Led full-cycle development of a production RAG conversational chatbot using Azure OpenAI, Redis, and Weaviate vector database; architected sticky session routing and load balancing to support 1K+ DAUs
...
• Architected scalable infrastructure: VM provisioning, runtime orchestration, offline pipelines for knowledge base synchronization and cache optimization
...
• Designed 7+ MuleSoft API integration workflows for delta updates of partner accounts and locations
...
Content Platform:
• Developed licensable software modules on Adobe Experience Manager for content authoring and multi-channel publishing
